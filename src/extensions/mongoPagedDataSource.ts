...
import type { Filter, QueryFieldsType, Sorter } from '@schamane/graphql-defs';
...
export abstract class MongoPagedDataSource<T extends Document, TContext extends DefaultGraphqlContext> extends MongoDataSource<T, TContext> {
